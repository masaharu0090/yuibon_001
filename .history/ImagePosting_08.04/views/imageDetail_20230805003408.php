...
<body>
    ...
    <div class="detailImageBox">
        <div class="detailImage">
            <img src="../assets/images/<?php echo $data['image']['file_name']; ?>" alt="投稿画像">
            <div class="detailImagButton">
                <button class="updateButton"
                    onclick="location.href='./postImageForm.php?id=<?php echo $_GET['id']; ?>';">更新</button>
                <button class="deleteButton"
                    onclick="location.href='../api/deleteImage.php?id=<?php echo $_GET['id']; ?>';">削除</button>
            </div>
            <button onclick="location.href='../html/index.php';">戻る</button>
        </div>
        <div class="comment">
            ...
            <div class="submitComment">
                <form action="../?image_id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
